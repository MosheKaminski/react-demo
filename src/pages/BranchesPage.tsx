...
import { useBranches, useCreateBranch, useSetBranchActive, useUpdateBranch } from '../features/branches/hooks';
        ...
        <TableBody>
          {(branches ?? []).map((branch) => (
            <TableRow key={branch.id}>
              ...
              <TableCell>
                {branch.manager_id ? employeesById.get(branch.manager_id) ?? '—' : t('branches.noManager')}
              </TableCell>
              <TableCell>
                <Chip
